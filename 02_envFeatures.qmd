...
pr # TODO: What are we trying to show here?
...
email <- "rlandfire@example.com"               # Replace with your email
...
# TODO: Maybe we should we also do the yearly minimum and yearly maximum as those are more likely to effect the species distribution
tmin_yr  <- min(tmin)
tmax_yr  <- min(tmax)
