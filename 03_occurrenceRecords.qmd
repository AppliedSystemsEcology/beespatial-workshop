...
This will bring up a file called **.Renviron**. Add your own credential information here (replace the info in quotes with your info), or you can use the account info that we will provide for this workshop.

```{r}
#| eval: false
# TODO is "fakeuser" the account info for this workshop?
GBIF_USER="fakeuser"
