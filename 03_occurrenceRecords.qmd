...
This will bring up a file called **.Renviron**. Add your own credential information here (replace the info in quotes with your info), or you can use the account info that WE WILL PROVIDE AT THE WORKSHOP. 
